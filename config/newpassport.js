...
var User2            = require('../app/models/home');
var User = User2.ex_user();
...
module.exports = function(passport) {
    ...
    passport.use('posting', new LocalStrategy({
        usernameField : 'email',
        passwordField : 'password',
        passReqToCallback : true
    },
    function(req, email, nama, done){
      console.log(email);
      return done(null, { emaild: email });
    }));
